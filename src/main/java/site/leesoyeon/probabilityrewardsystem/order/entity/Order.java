package site.leesoyeon.probabilityrewardsystem.order.entity;
...
public class Order extends BaseTimeEntity {
    ...
    public void updateStatusBasedOnShipping(ShippingStatus shippingStatus) {
        this.status = OrderStatus.valueOf(shippingStatus.name());
    }
}
