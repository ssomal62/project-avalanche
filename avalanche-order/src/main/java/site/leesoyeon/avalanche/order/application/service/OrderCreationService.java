...
import site.leesoyeon.avalanche.order.infrastructure.exception.OrderStatusException;
...
public class OrderCreationService {
    ...
    public OrderContext createOrder(OrderContext context) {
        try {
            ...
            return context.orderCreationFailed("주문 생성에 실패하였습니다: " + e.getMessage());
        }
    }
    ...
    public OrderContext cancelOrder(OrderContext context) {
        try {
            ...
            return context.orderCreationFailed("주문 취소에 실패하였습니다: " + e.getMessage());
        }
    }
    ...
    public OrderContext updateOrderWithShippingInfo(OrderContext context) {
        try {
            ...
            return context.orderCreationFailed("주문 업데이트에 실패하였습니다: " + e.getMessage());
        }
    }
}
